...
public class App {
    ...
    private static String username = "lv395";
    private static String password = "Lv395_Taqc";
    //
    // Microsoft
    ...
    ////private static String URL ="jdbc:jtds:sqlserver://ssu-oms/_067_OMS1;instance=SQLEXPRESS;";
    //
    // 192.168.195.239
    //
    // MySQL
    ...
    // private static String URL = "jdbc:mysql://localhost:3306/lv374oms";
    ////private static String URL = "jdbc:mysql://10.26.34.98:3306/mytemp";
    private static String URL = "jdbc:mysql://10.26.34.98:3306/opencart";
    //
    // PostgresSQL
    // private static String URL =
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 'Tar%';");
        //
        // st.execute("CREATE DATABASE lv375work;");
//          st.execute("CREATE SCHEMA `lv375work` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;");
...
//          st.execute("DELETE FROM MyUsers WHERE id=5;");
        ...
        //
        // st.execute("INSERT INTO temp (name,login,password,age) VALUES
        // ('Mykola','Myk','qwerty',25);");
        ...
        //
        // st.execute("INSERT INTO dbo.Users (Login, Password, FirstName, LastName,
        // Email, RegionRef, RoleRef, IsUserActive) VALUES ('temp', 'qwerty', 'ivatemp',
        // 'horoshkotemp', 'temp@gmail.com', '1', '1', '1');");
        // st.execute("select * from Users;");
        // ResultSet rs = st.getResultSet();
        //
        ////st.execute("UPDATE oc_customer_login SET total='1' WHERE email LIKE 'haha%';");
        ////st.execute("DELETE FROM oc_customer_login WHERE email LIKE 'haha%';");
        //
        ...
        // st.execute("UPDATE Users SET FirstName='SuperName41' WHERE Login LIKE
        // 'login%';");
        ////ResultSet rs = st.executeQuery("select * from Users;");
        //
        // ResultSet rs = st.getResultSet();
